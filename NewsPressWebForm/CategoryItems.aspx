             ...
             $.getJSON(url,
                 function (data) {
                     ...
                     $.each(data, function (key, val) {
                         ...
                         var row = '<td name="Name"' + 'id=' + key + '>' + val.Name + '</td><td name="Text"' + 'id=' + key + '>' + val.Text + '</td><td name="Date"' + 'id=' + key + '>' + val.Date + '</td><td name="LinkUrl"' + 'id=' + key + '>'  + val.LinkUrl + '</td><td><button id="editBtn" onclick=editClick(event,' + key + ')>Edit</button><button id="deleteBtn" onclick=deleteClick(event,' + key + ')>Delete</button></td>';
